...
class mh_magazine_lite_posts_large_tag extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_magazine_lite_posts_large_tag', esc_html_x('MH Posts Large Tag[lite]', 'widget name', 'mh-magazine-lite'),
			array(
				'classname' => 'mh_magazine_lite_posts_large_tag',
