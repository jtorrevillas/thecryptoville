...
class mh_magazine_lite_posts_multiple extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_magazine_lite_posts_multiple', esc_html_x('MH Posts Multiple[lite]', 'widget name', 'mh-magazine-lite'),
			array(
				'classname' => 'mh_magazine_lite_posts_multiple',
