...
class mh_magazine_lite_posts_focus_tagged extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_magazine_lite_posts_focus_tagged', esc_html_x('MH Posts Focus Tagged [lite]', 'widget name', 'mh-magazine-lite'),
			array(
				'classname' => 'mh_magazine_lite_posts_focus_tagged',
        ...
        echo $args['before_widget'];
			if ($widget_posts->have_posts()) :
				...
				echo '<div class="mh-row mh-posts-focus-widget mh-clearfix">' . "\n";
					while ($countMe < 3 && $widget_posts->have_posts()) : $widget_posts->the_post();
						if ($counter === 1) { ?>
